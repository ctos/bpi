...
)
{
	...
	auto const mach_msg_type_t responseCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		3,
		/* msgt_inline = */		TRUE,
	...
	InP->hostType = hostType;

	(void) mig_strncpy(InP->host, host, 1024);
...
#if	TypeCheck
	if (BAD_TYPECHECK (&OutP->responseType, &responseCheck))
		return MIG_TYPE_ERROR;
#endif	/* TypeCheck */

	*response = OutP->response;
...
)
{
	...
	auto const mach_msg_type_t requestType = {
		/* msgt_name = */		MACH_MSG_TYPE_STRING_C,
		/* msgt_size = */		8,
		/* msgt_number = */		1024,
		/* msgt_inline = */		TRUE,
	...
	(void) mig_strncpy(InP->request, request, 1024);
